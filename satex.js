...
//this variable is pre-programmed with our authentication api key from NYTimes web received when registered
var authkey = 'f6ffb90ea9e84bc99649318f69e52264'
...
// The AJAX function uses the URL & Gets the JSON data associated with it.
// The data then gets stored in the variable called: "NYTData"
    $.ajax({url: queryURL, method: "GET"})
        .done(function(NYTData) {
            ...
            // Add to the Article Counter (to have right #of articles for page)
            articleCounter++;
